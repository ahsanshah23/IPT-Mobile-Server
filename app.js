...
app.use('/fyp1proposal_view', (req, res) => {
    ...
    db.execute("SELECT * FROM fyp1_proposal where leader_email='"+leader+"'")
        .then(results => {
            res.send(results[0])
        })
        .catch(err => {
...
app.use('/fyp1midevaluation_add', (req, res) => {
    ...
    db.execute(" INSERT INTO fyp1_mid_evaluation (ID, Project_Title, leader_email, leader_name, member2_email, member2_name, member3_email, member3_name, supervisor_email, cosupervisor_email, Project_Status, Criteria1_Marks, Criteria2_Marks, Criteria3_Marks, Criteria4_Marks, Criteria5_Marks, Criteria6_Marks, Deliverable1, Deliverable2, Deliverable3, Deliverable4, Deliverable5, Recommended_Changes, Comments_To_FYP_Committee, Evaluator1_Name, Evaluator2_Name ) VALUES (' ', '" + Title + "', '" + leadername + "', '" + leaderemail + "','" + member2name + "','" + member2email + "','" + member3name + "','" + member3email + "','" + supervisor_email + "','" + cosupervisor_email + "', '"+status+"', '"+markcriteria1+"','"+markcriteria2+"','"+markcriteria3+"','"+markcriteria4+"','"+markcriteria5+"','"+markcriteria6+"','"+deliverable1+"','"+deliverable2+"','"+deliverable3+"','"+deliverable4+"','"+deliverable5+"', '"+changes+"','"+comments+"','"+evaluator+"','"+coevaluator+"') ")
        .then(results => { 
            res.send('Inserted');
        })                                                      
});
...
app.use('/jurysubmitted_list', (req, res) => {
    ...
    db.execute("Select Project_Title,leader_email, supervisor_email from fyp2_final_evaluation_external where Email='"+email+"' ")
        .then(results => {
            res.send(results[0])
        })
        .catch(err => {
